...
var EmisionRemitos = (function () {
    ...
    function EmisionRemitos(recursoService, emisionRemitosService, utilsService, popupListaService, comprobanteService, _state, router, contratosService) {
        ...
        this.onClickConfirmEdit = function (tipoColumnas) { return function (itemSelect) {
            // cotas de precios ///
            var permisoCotaPrecio;
            var permisoModificaPrecio;
            _this.statusPorcentajeCotas = "";
            _this.statusPreciosCotas = "";
            // cota de %
            var permisoCotaPorcentaje;
            var permisoModificaPorcentaje;
            ...
            if ((itemSelect.cotaInfPorc == 0 && itemSelect.cotaSupPorc == 0) || (itemSelect.cotaInfPorc == undefined && itemSelect.cotaSupPorc == undefined)) {
            ...
            if (permisoCotaPrecio == true && permisoCotaPorcentaje == true) {
                if (true) {
                    if (itemSelect.pendienteOg) {
                        if (Number(itemSelect.pendiente) > Number(itemSelect.pendienteOg)) {
                ...
                if (permisoModificaPrecio == false) {
                    ...
                    if (permisoCotaPrecio == false) {
                        _this.statusPreciosCotas = "Error :: El Precio del articulo  no esta dentro de las cotas permitidas ( >= " + itemSelect.cotaInferior + " y <= " + itemSelect.cotaSuperior + ").";
                        itemSelect.precio = _this.precioOriginal;
                    }
                    else {
                        _this.statusPreciosCotas = "";
                ...
                if (permisoModificaPorcentaje == false) {
                    ...
                    if (permisoCotaPorcentaje == false) {
                        _this.statusPorcentajeCotas = "Error :: El Procentaje de descuento  del producto  no esta dentro de las cotas permitidas ( >= " + itemSelect.cotaInfPorc + " y <= " + itemSelect.cotaSupPorc + ").";
                        itemSelect.descuento = _this.descuentoOriginal;
                    }
                    else {
                        _this.statusPorcentajeCotas = "";
        ...
        this.buscaEstadosSisa = function (idPadron) {
            _this.emisionRemitosService.getEstadosSisa(idPadron).subscribe(function (data) {
                ...
                _this.emisionRemitosService
                    ...
                    var existeProd = _this.tablas.datos.productosPend.find(function (prod) {
                        return prod.numero === auxProdSelect.numero &&
                            ...
                            prod.producto.codProducto == auxProdSelect.producto.codProducto;
                    });
                    if (!existeProd) {
            ...
            return _this.emisionRemitosService.existsProductsWithoutCantidad(_this.tablas.datos.productosPend)
                ...
                : _this.utilsService.showModal("Confirmar")("¿Confirmar emision de comprobante?")(function () {
                    ...
                    if (_this.fechaComprobanteInvalida()) {
                        ...
                        _this.emisionRemitosService
                            .confirmarYEmitirRemito(_this.comprobante)(_this.comprobanteRelacionado)(_this.cliente)(_this.tablas.datos.productosPend)(_this.cotizacionDatos)(_this.sisCanje)(_this.formasPagoSeleccionadas)(_this.factura)(_this.tablas.datos.modelosFactura)(_this.tablas.datos.detallesFormaPago)(_this.deposito)(_this.tablas.datos.lotesTraza)(_this.tipoOperacion)(_this.dataVendedor)(_this.tablas.datos.subtotalesProductos)(_this.listaPrecioSelect)(_this.contrato)(_this.relacionCanje)(_this.cereal)(_this.diferidoVto)(_this.pesificado)(_this.marcaPesificado)(_this.pesificadoPersisteSn)(_this.comprobantePesificadoInterno)
                            .catch(function (err) {
                            ...
                            if (_this.comprobante.tipo.cursoLegal) {
                                ...
                                _this.utilsService.showImprimirModalAceptar(respuesta.control.codigo)("" + respuesta.control.descripcion)(function () {
                                    _this.recursoService.downloadComp(compCreado_1, null, _this.nroCopias);
                                    _this.blanquearCampos();
                                })(compCreado_1)(function () {
                                    _this.blanquearCampos();
                                });
                                ...
                                compCreado_2.idFactCab = respuesta.datos.idFactCab;
                                compCreado_2.numero = Number("" + _this.comprobante.numerador.ptoVenta.ptoVenta + _this.comprobante.numerador.ptoVenta.ptoVenta
                                    .toString()
                                    .padStart(8, "0"));
                                _this.utilsService.showImprimirModalAceptar(respuesta.control.codigo)("" + respuesta.control.descripcion)(function () {
        ...
        this.keyPressInputTexto = function (e) { return function (upOrDown) {
            e.preventDefault();
            // Hace todo el laburo de la lista popup y retorna el nuevo indice seleccionado
            _this.clienteEnfocadoIndex = _this.popupListaService.keyPressInputForPopup(upOrDown)(_this.clientes.filtrados.value)(_this.clienteEnfocadoIndex);
        }; };
        /**
        ...
        this.handleFormaPagoSelec = function (fp) { return function (tipoOperacion) {
            ...
            if (tipoOperacion === "add") {
                if (fp.descripcion == "Canje" || fp.descripcion == "Dólar Abierto") {
                    _this.formasPagoSeleccionadas = [];
        ...
        this.actualizarTotalNeto = function () {
            ...
            _this.cotizacionDatos.total = _this.comprobante.tipo.comprobante.incluyeNeto
        ...
        this.actualizarTrazableLotes = function (prodToDelete) {
            ...
            if (_this.tablas.datos.productosPend.length > 0) {
                _this.emisionRemitosService
                    ...
                    if (prodToDelete) {
                        _this.tablas.datos.lotesTraza = _this.tablas.datos.lotesTraza.filter(
                        // TODO: Fijarse si está filtrando bien acá. Quizás filtrar por idFactDetalle
                        function (lot) { return lot.idProducto === prodToDelete.producto.idProducto; });
                    }
                });
            }
            else {
        ...
        this.fetchFacturas = function () {
            ...
            if (_this.cliente &&
                ...
                _this.emisionRemitosService
                    .buscaModelos(_this.tablas.datos.productosPend, _this.tablas.datos.subtotalesProductos, _this.comprobante.moneda ? _this.comprobante.moneda.idMoneda : null, _this.cliente.padronCodigo, _this.tipoOperacion.idSisTipoOperacion, _this.comprobante.tipo.idCteTipo, _this.estadoSisa, _this.percep2459)
                    ...
                    if (encabezados.control.codigo == "OK" &&
                        ...
                        encabezados.arraydatos.forEach(function (encabezado) {
                            encabezado.detalle.forEach(function (detalle) {
                                descripcion_1 +=
                                    detalle.articulo + " - " + detalle.pendiente + " unidades \n";
                            });
                        });
        ...
        this.calcRestoPagar = function () {
            var sumMontos = _.sumBy(_this.tablas.datos.detallesFormaPago, function (fPago) {
                return Number(fPago.monto) ? Number(fPago.monto) : 0;
            });
            // Los paréntesis son ilustrativos, ya sabemos que la suma es asociativa y conmutativa
            var restoPagar = _this.utilsService.toLocateString(Number(_this.cotizacionDatos.total + _this.sumatoriaSubtotales - sumMontos).toFixed(2));
        ...
        this.disabledConfirmar = function () {
            ...
            var relacionadoNoValido = _this.comprobante &&
                _this.comprobante.tipo &&
                (_this.comprobante.tipo.idCteTipo == 77 ||
                    _this.comprobante.tipo.idCteTipo == 76) &&
        ...
        this.onBlurNumeradorCteRel = function (e) {
            return _this.utilsService.onBlurInputNumber(e) && _this.comprobanteRelacionado.numero
        ...
        this.onClickConfirmRelacionado = function () {
            if (_this.numeroComprobanteAfipRelacionado && _this.ptoVentaAfipRelacionado) {
        ...
        this.onClickBuscarPesificado = function () {
            _this.emisionRemitosService
                ...
                if (response) {
                    ...
                    if (response.cotDolar < _this.cotizacionDatos.cotizacion.cotizacion) {
                        _this.comprobante.tipo =
                        ...
                        _this.monedas = _this.comprobante.tipo.comprobante.monedas;
                        _this.comprobante.moneda =
                        ...
                        if (response.diferidoVto) {
                            ...
                            valorTotal105_1 = valorTotal105_1 + valorTotal105_1 * 0.105;
                        }
                    ...
                    else if (response.cotDolar > _this.cotizacionDatos.cotizacion.cotizacion) {
                        _this.comprobante.tipo =
        ...
        this.getCantidadCanjeReferencia = function () {
            return _this.comprobante &&
                ...
                ? _this.relacionCanje &&
                    ...
                    : 0
                : _this.utilsService.parseDecimalNumber(Number(_this.utilsService.parseDecimal(_this.cotizacionDatos.total)) /
                    _this.sisCanje.precio);
        };
        ...
        this.tiposOperacion = this.tiposOperacion.map(function (tiposOp) {
            return tiposOp.filter(function (tipoOp) {
                return tipoOp.idSisTipoOperacion == 4 || tipoOp.idSisTipoOperacion == 10;
            });
        });
